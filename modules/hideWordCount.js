/* modules/hideWordCount.js — hide word counts via the module's own toggle */
;(function () {
  'use strict';
  ...
  // CSS once
  (function injectCSS(){
    const CSS_ID = 'ao3h-hide-wc';
    const CSS_TEXT = `
      html.${HIDE_CLASS} dl.stats dd.words,
      html.${HIDE_CLASS} .stats .words,
      html.${HIDE_CLASS} li.words,
      html.${HIDE_CLASS} span.words { display: none !important; }
    `;
  ...
  AO3H.modules.register(MOD, { title: 'Hide word count', enabledByDefault: true }, async function init () {
